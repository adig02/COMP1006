  ...
  <body>
    ...
    <?php
        ...
        if(isset($_POST['Submit'])){
            ...
            $checkbox1 = $_POST['check_list']; // stores the selected valued
            ...
            if($msg != null){
                // if there are empty fields then show message
                echo "<p>" . $msg . "</p>";
                ...
                // if the email is not valid show the message
                echo "<p>Please enter a valid email</p>";
                echo "<a href='javascript:self.history.back();'>Go Back</a>";
            } else{
                // if everything check out then we can move our new record to the database
                $result = $crud->execute("INSERT INTO createRead(name, age, email, checkbox) VALUES('$name','$age','$email','$chk')");
