<?php
    // Define the class called validate to hold all the validation functions
    class validate{
        ...
        public function validAge($age){
            /**
             * preg_match checks if the input $age matches the regular expression pattern
             * The pattern "/^[0-9]+$/" means:
             * ^ -> this is the start of our string
             * [0-9] -> One or more digits (0 through 9)
             * $ -> this is the end of our string
             * this pattern is a good way to check if age is a whole number
