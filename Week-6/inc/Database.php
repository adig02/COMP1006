<?php
    // include our config file for connection
    require_once 'config.php';
    class Database {
        // private property to hold our PDO connection
        private $pdo;
        ...
        private function validateImage(array $fileData){
            ...
            $maxSize = 2 * 1024 * 1024; // or could just say 2MB
            if ($fileSize > $maxSize){
         ...
         * @param string $fileData - the $_FILES array for the image
        ...
        public function create($name, $description, array $fileData){
            ...
            try {
                ...
                // stops duplication, if error in the insert statement
